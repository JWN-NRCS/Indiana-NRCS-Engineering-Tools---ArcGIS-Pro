# ==========================================================================================
# Name: Wascob_CreateStreamNetwork.py
#
# Author: Peter Mead
...
#
# The only difference between the Wascob_CreateStreamNetwork and the Create_Stream_Network
# tools is that the Wascob version uses the "_Raw_DEM" that is created from step 1 of the
# Wascob Design toolset.  This tool will also aggregate the DEM to a 10 FT or a 3M if the
# DEM's resolution is finer.
#
# ==========================================================================================
# Updated  6/12/2020 - Adolfo Diaz
#
...
##        arcpy.Delete_management(outStreamLink)
        ...
        # ------------------------------------------------------------------------------------------------ Compact FGDB
        arcpy.SetProgressorLabel("Compacting FGDB: " + os.path.basename(watershedGDB_path))
